...
if __name__ == "__main__":
    ...
    hyperparameters = {
        # Tuning parameters
        "data_dir": "/work/dlclarge2/koeksalr-crispr/datasets/evo/bin_data_only_bona_fide",
        "eval_steps": 1,
        "eval_strategy": "epoch",
        "do_eval": False,
        "dropout_prob": 0.1,
        ...
        "lora_task_type": TaskType.CAUSAL_LM, # Since the task for the evo model is still a causal LM, and the binary head is not affected by LoRA, we can keep this as is
    ...
    model = EvoBinaryTokenClassificationModel(
        lora_config,
    ...
    training_args = TrainingArguments(
        ...
        # resume_from_checkpoint='/work/dlclarge2/koeksalr-crispr/results/checkpoints', # TODO change model to allow checkpointing
    ...
    # Save the model
    model.save_pretrained(f"/work/dlclarge2/koeksalr-crispr/results/bin/model-{slurm_job_id}")

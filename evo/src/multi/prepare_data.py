...
dataset = datasets.load_dataset('csv', data_files='/work/dlclarge2/koeksalr-crispr/crispr-datasets/output_crispr_data.csv')
...
dataset.save_to_disk('/work/dlclarge2/koeksalr-crispr/crispr-datasets/evo/multi_data_only_bona_fide')

...
if __name__ == "__main__":
    ...
    model_dir = "/work/dlclarge2/koeksalr-crispr/results/multi/model-26970507-26970507"
    if model_id is not None:
        model_dir += f"-{model_id}"

    model = EvoMultiClassTokenClassificationModel.from_pretrained(model_dir)

    data_dir = "/work/dlclarge2/koeksalr-crispr/crispr-datasets/evo/multi_data_only_bona_fide/test"
    ...
    output_path = "/work/dlclarge2/koeksalr-crispr/results/infer_subseq_arrays"
    if model_id:
